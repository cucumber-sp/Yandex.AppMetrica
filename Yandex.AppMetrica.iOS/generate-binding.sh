...
echo "SDK used: ${SDK}"
sharpie bind -output ./ -namespace YandexMetricaIOS -sdk "${SDK}" -scope Frameworks/YandexMobileMetrica.xcframework Frameworks/YandexMobileMetrica.xcframework/ios-arm64_armv7/YandexMobileMetrica.framework/Headers/YandexMobileMetrica.h
