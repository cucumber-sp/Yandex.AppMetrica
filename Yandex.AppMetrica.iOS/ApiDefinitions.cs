...
*/[Protocol]
	...
	interface YMMYandexMetricaPreloadInfo : INSCopying
	{
		...
		NativeHandle Constructor (string trackingID);
...
*/[Protocol]
	...
	interface YMMUserProfile : INSCopying, INSMutableCopying
	{
		...
		NativeHandle Constructor (YMMUserProfileUpdate[] updates);
	}
	...
	interface YMMRevenueInfo : INSCopying, INSMutableCopying
	{
		...
		NativeHandle Constructor (double price, string currency);
		...
		NativeHandle Constructor (NSDecimalNumber priceDecimal, string currency);
		...
		NativeHandle Constructor (double price, string currency, nuint quantity, [NullAllowed] string productID, [NullAllowed] string transactionID, [NullAllowed] NSData receiptData, [NullAllowed] NSDictionary payload);
		...
		NativeHandle Constructor (NSDecimalNumber priceDecimal, string currency, nuint quantity, [NullAllowed] string productID, [NullAllowed] string transactionID, [NullAllowed] NSData receiptData, [NullAllowed] NSDictionary payload);
	}
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface YMMError : IYMMErrorRepresentable
	{
	...
	interface YMMECommerceAmount
	{
		...
		NativeHandle Constructor (string unit, NSDecimalNumber value);
	}
	...
	interface YMMECommercePrice
	{
		...
		[Export ("initWithFiat:")]
		NativeHandle Constructor (YMMECommerceAmount fiat);
		...
		NativeHandle Constructor (YMMECommerceAmount fiat, [NullAllowed] YMMECommerceAmount[] internalComponents);
	}
	...
	interface YMMECommerceScreen
	{
		...
		NativeHandle Constructor ([NullAllowed] string name, [NullAllowed] string[] categoryComponents, [NullAllowed] string searchQuery, [NullAllowed] NSDictionary<NSString, NSString> payload);
	}
	...
	interface YMMECommerceProduct
	{
		...
		[Export ("initWithSKU:")]
		NativeHandle Constructor (string sku);
		...
		NativeHandle Constructor (string sku, [NullAllowed] string name, [NullAllowed] string[] categoryComponents, [NullAllowed] NSDictionary<NSString, NSString> payload, [NullAllowed] YMMECommercePrice actualPrice, [NullAllowed] YMMECommercePrice originalPrice, [NullAllowed] string[] promoCodes);
	}
	...
	interface YMMECommerceReferrer
	{
		...
		NativeHandle Constructor ([NullAllowed] string type, [NullAllowed] string identifier, [NullAllowed] YMMECommerceScreen screen);
	}
	...
	interface YMMECommerceCartItem
	{
		...
		NativeHandle Constructor (YMMECommerceProduct product, NSDecimalNumber quantity, YMMECommercePrice revenue, [NullAllowed] YMMECommerceReferrer referrer);
	}
	...
	interface YMMECommerceOrder
	{
		...
		NativeHandle Constructor (string identifier, YMMECommerceCartItem[] cartItems);
		...
		NativeHandle Constructor (string identifier, YMMECommerceCartItem[] cartItems, [NullAllowed] NSDictionary<NSString, NSString> payload);
	}
...
*/[Protocol]
	...
	interface YMMPluginErrorDetails
	{
		...
		NativeHandle Constructor ([NullAllowed] string exceptionClass, [NullAllowed] string message, [NullAllowed] YMMStackTraceElement[] backtrace, [NullAllowed] string platform, [NullAllowed] string virtualMachineVersion, [NullAllowed] NSDictionary<NSString, NSString> pluginEnvironment);
	}
	...
	interface YMMStackTraceElement
	{
		...
		NativeHandle Constructor ([NullAllowed] string className, [NullAllowed] string fileName, [NullAllowed] NSNumber line, [NullAllowed] NSNumber column, [NullAllowed] string methodName);
	}
	...
	interface YMMAdRevenueInfo : INSCopying, INSMutableCopying
	{
		...
		NativeHandle Constructor (NSDecimalNumber adRevenue, string currency);
	}
